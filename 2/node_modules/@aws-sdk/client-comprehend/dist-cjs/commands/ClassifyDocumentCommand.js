...
class ClassifyDocumentCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, ClassifyDocumentCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_json1_1_1.se_ClassifyDocumentCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_json1_1_1.de_ClassifyDocumentCommand)(output, context);
    }
}
