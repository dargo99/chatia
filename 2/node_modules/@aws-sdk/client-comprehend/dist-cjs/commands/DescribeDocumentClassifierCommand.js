...
class DescribeDocumentClassifierCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, DescribeDocumentClassifierCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_json1_1_1.se_DescribeDocumentClassifierCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_json1_1_1.de_DescribeDocumentClassifierCommand)(output, context);
    }
}
