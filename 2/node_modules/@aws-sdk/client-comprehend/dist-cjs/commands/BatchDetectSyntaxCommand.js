...
class BatchDetectSyntaxCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, BatchDetectSyntaxCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_json1_1_1.se_BatchDetectSyntaxCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_json1_1_1.de_BatchDetectSyntaxCommand)(output, context);
    }
}
