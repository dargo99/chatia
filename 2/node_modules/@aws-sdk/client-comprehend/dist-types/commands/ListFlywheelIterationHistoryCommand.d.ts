...
export declare class ListFlywheelIterationHistoryCommand extends $Command<ListFlywheelIterationHistoryCommandInput, ListFlywheelIterationHistoryCommandOutput, ComprehendClientResolvedConfig> {
     ...
     * @public
     */
    constructor(input: ListFlywheelIterationHistoryCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: ComprehendClientResolvedConfig, options?: __HttpHandlerOptions): Handler<ListFlywheelIterationHistoryCommandInput, ListFlywheelIterationHistoryCommandOutput>;
    /**
     * @internal
     */
    private serialize;
