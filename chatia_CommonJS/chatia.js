...
fetch('chatia-config.json')
    ...
    .then(data => {
        ...
        // Cargar las credenciales de Amazon Cognito
        AWS.config.region = 'us-east-1'; // Región
        AWS.config.credentials = new AWS.CognitoIdentityCredentials({
            IdentityPoolId: 'us-east-1:a17101db-a6eb-421d-81bf-cdefa561430e',
        });
        ...
        function pushChat() {
            ...
            var params = {
                ...
                userId: "4ospbqat2o6n9118dkno65k4q3",
